...
#define MICQ_BUILD_NUM 0x00040a05
...
{
#if ENABLE_UTF8
    return ("\xc2\xa9 1998-2000 Matthew D. Smith, \xc2\xa9 2001,2002,2003,2004 R\xc3\xbc" "diger Kuhlmann,\n"
            "released under version 2 of the GNU General Public License (GPL).\n");
#else
    return ("\xa9 1998-2000 Matthew D. Smith, \xa9 2001,2002,2003,2004 R\xfc" "diger Kuhlmann,\n"
            "released under version 2 of the GNU General Public License (GPL).\n");
#endif
}                  
